const ABP4_black = document.querySelector(".buy-product-container .buy-product-buy_process .main-product-color .ABP4-black");
const ABP4_pink = document.querySelector(".buy-product-container .buy-product-buy_process .main-product-color .ABP4-pink");
...
ABP4_black.addEventListener("click", () => {
    buy_main_product.href = "https://wa.link/izg5sx";
});
ABP4_pink.addEventListener("click", () => {
    buy_main_product.href = "https://wa.link/t1ssvl";
});
